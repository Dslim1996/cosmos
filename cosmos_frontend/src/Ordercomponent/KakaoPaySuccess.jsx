...
const KakaoPaySuccess=(props)=>{
    ...
    return(
        <div style={{marginTop:'50px', textAlign:'center'}}>
            ...
            <div style={orderInfo.amount!=null?{}:{display:"none", textAlign:'center'}}>
                <h2>상품 주문이 완료되었습니다.</h2>
                <h3>상품명 : {orderInfo.item_name}</h3>
                <h3>승인 시간: {orderInfo.approved_at}</h3>
                <h3>총 주문 금액: {orderInfo.amount!=null?orderInfo.amount["total"]:"0"}</h3>
                <div>
