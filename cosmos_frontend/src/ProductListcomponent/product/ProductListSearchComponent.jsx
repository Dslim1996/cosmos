                ...
                <Grid item xs={12}> 
                    ...
                    <div>
                        <FormControl style={{minWidth:'80px'}}>
                            <button onClick={() => reset()} style={{border:'0px', backgroundColor:'white'}} ><InputLabel>Clothing</InputLabel></button>
                        </FormControl>
                        <FormControl style={{minWidth:'80px'}}>
                            <a href="http://13.125.40.117/accessories-list"> <InputLabel>Accessories</InputLabel></a>
                        </FormControl>
                    </div>
                        ...
                        <div align="right" onClick = {() => {Productinfo(product.product_id)}}>
                            ...
                            <TableRow>
                                ...
                                {product.colorSet.map(color=>
                                        <div key={color.index}>
                                            <div style={{marginRight:'3px', float:'left', width:'15px', height:'15px', backgroundColor:color, border:'1px solid lightgray'}}></div>     
                                        </div>
                                    )}
                                </TableCell>
                            </TableRow>
